...
// NopLogger is a no-op implementation of events.AuditLogger that discards all events.
...
// StdoutLogger is an implementation of events.AuditLogger that writes JSON-formatted
