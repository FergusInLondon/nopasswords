...
export function getGroup(groupID: number): SRPGroup {
  switch (groupID) {
    case 3: // RFC5054 2048-bit group (recommended minimum).
      return {
        N: BigInt(
          '0x' +
    ...
    case 4: //RFC5054 3072-bit group (stronger security, higher CPU cost).
      return {
        N: BigInt(
          '0x' +
    ...
    case 5: // RFC5054 4096-bit group (strongest security, significant CPU cost).
      return {
        N: BigInt(
          '0x' +
          'FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD129024E088A67CC74' +
